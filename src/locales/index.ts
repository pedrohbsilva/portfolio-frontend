...
export const languages: MessageProps = {
  ...
  'en-US': {
    ...
    language: 'Language',
    portfolio: 'Portfolio',
    portfolioMessage: "Here are some of the projects I've developed.",
    ptBR: 'pt-BR',
    teaching: 'Teaching',
  },
};
